export default function Work() {
  return (
    <div className='flex justify-center items-center montserrat text-gray-50 text-2xl pb-20'>
        <div className='space-y-8 px-12 sm:px-24 md:px-32 lg:px-48 xl:px-60 2xl:px-72'>
